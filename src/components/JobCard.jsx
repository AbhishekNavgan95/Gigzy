        ...
        <div className='p-5 w-full bg-white border-2 rounded-md shadow-md'>
            <div className='flex items-start md:items-center gap-y-1 gap-x-3 justify-between flex-col md:flex-row'>
                <div className='flex gap-3 items-center'>
                    ...
                    <span>
                        <span className='flex flex-col sm:flex-row flex-wrap items-start md:items-center gap-x-3'>
                            <Link to={`/job/${job.id}`}><h2 className='text-lg font-semibold hover:underline'>{job?.title}</h2></Link>
                            <span className='flex gap-x-1 py-2'>
                                <p className="flex items-center text-green-700 text-sm font-semibold bg-green-100 px-3 py-[2px] tracking-wide rounded-full">
                                ...
                                <p className="flex items-center text-blue-700 text-sm font-semibold bg-blue-100 px-3 py-[2px] tracking-wide rounded-full">
                ...
                <div className='flex items-center justify-between md:justify-start gap-3 w-full md:w-max'>
                    ...
                    <ToolTip text={'Save'}>
                        <button className='p-2 rounded-full text-xl' onClick={handleSaveJob}>
                            {
