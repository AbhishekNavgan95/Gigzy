...
const HeroSection = () => {
    ...
    return (
        <section className='grid-background pt-24 pb-5 lg:pt-36 flex flex-col gap-y-12 lg:gap-y-20 px-3'>
            <div className='px-3 flex flex-col lg:flex-row items-center justify-center gap-y-10 gap-x-6 lg:gap-14 xl:gap-x-24'>
                <div className='text-black-800 flex flex-col items-center lg:items-end gap-y-5 md:gap-4'>
                    <span className='font-space text-3xl md:text-5xl flex flex-col justify-center items-center lg:items-end gap-2 md:gap-4 text-center lg:text-right capitalize'>
                ...
                <div className='hero-crop'>
                    <img src={'./hero.png'} className='border-8 aspect-square border-accent-600 w-[300px] lg:w-[500px] hero-crop object-cover' alt="hero-image" />
                </div>
            </div>
